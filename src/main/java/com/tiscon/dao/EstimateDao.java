...
public class EstimateDao {
    ...
    public int insertCustomer(Customer customer) {
        String sql = "INSERT INTO CUSTOMER(OLD_PREFECTURE_ID, NEW_PREFECTURE_ID, CUSTOMER_NAME, TEL, EMAIL, OLD_ADDRESS, NEW_ADDRESS, MOVE_YEAR, MOVE_MONTH, MOVE_DAY)"
                + " VALUES(:oldPrefectureId, :newPrefectureId, :customerName, :tel, :email, :oldAddress, :newAddress, :moveYear, :moveMonth, :moveDay)";
    ...
    /**
     * 段ボール箱のトラック搭載上限(大きい方のトラックに載る段ボール数)を取得する。
     *
     * @return 段ボール数
     */
